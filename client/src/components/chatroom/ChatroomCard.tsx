...
> = ({
  ...
  return (
    <div
      className='w-full py-7 px-6 flex flex-row justify-between items-end bg-my-dark border-b-2 border-white cursor-pointer hover:bg-my-dark-dark transition-all duration-200 ease-in-out'
      onClick={() =>
        setCurrentChatroomInfo({
          createdAt,
          id,
